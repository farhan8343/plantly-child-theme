<div class="dokan-product-inventory dokan-edit-row <?php echo esc_attr( $class ); ?>">
    ...
    <div class="dokan-section-content">
        <div class="content-half-part dokan-form-group hide_if_variation">
            <label for="_sku" class="form-label"><?php esc_html_e( 'ID/SKU', 'dokan-lite' ); ?> <span><?php esc_html_e( '(Stock Keeping Unit)', 'dokan-lite' ); ?></span></label>
        ...
        <div class="show_if_stock dokan-stock-management-wrapper dokan-form-group dokan-clearfix">
            ...
            <div class="content-half-part hide_if_variation">
                ...
                <input type="number" class="dokan-form-control" name="_stock" placeholder="<?php esc_attr__( '1', 'dokan-lite' ); ?>" value="<?php echo esc_attr( wc_stock_amount( $_stock ) ); ?>" min="0" step="1" oninput="this.value = Math.abs(this.value)">
            </div>
            ...
            <div class="content-half-part hide_if_variation">
                ...
                <input type="number" class="dokan-form-control" name="_low_stock_amount" placeholder="<?php esc_attr__( '1', 'dokan-lite' ); ?>" value="<?php echo esc_attr( wc_stock_amount( $_low_stock_amount ) ); ?>" min="0" step="1" oninput="this.value = Math.abs(this.value)">
            </div>
            <?php endif; ?>
