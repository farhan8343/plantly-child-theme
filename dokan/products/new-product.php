...
<?php if ( !empty( $_GET['new'] ) ) { ?>
                    <div class="dokan-message">
                        <button type="button" class="dokan-close" data-dismiss="alert">&times;</button>
                        <?php echo sprintf( '<b>SWEET!</b> Your new product was just added.', max( ( isset( $post_id ) ? $post_id : 0 ), (int)$_GET['new'] ) ) ?>
                        <?php if ( isset( $post ) && $post->post_status == 'publish' ) { ?>
                            <a href="<?php echo esc_url( get_permalink( $post_id ) ); ?>" target="_blank"><?php esc_html_e( '&rarr; View Product', 'dokan-lite' ); ?></a>
                        <?php echo '<em>Feel free to make additional tweaks below.</em>' ?>
                        <?php } ?>
                    </div>
                <?php } ?>
                        ...
                        <form class="dokan-form-container" method="post">
                            ...
                            <div class="product-edit-container dokan-clearfix">
                                    ...
                                    <div class="featured-image">
                                        <div class="dokan-feat-image-upload">
                                            <div class="instruction-inside <?php echo esc_attr( $hide_instruction ); ?>">
                                                ...
                                                <a href="#" class="dokan-feat-image-btn dokan-btn"><i class="fa fa-cloud-upload"></i><?php esc_html_e( 'Upload Product Image', 'dokan-lite' ); ?></a>
                                            </div>
                                ...
                                <div class="content-half-part dokan-product-meta">
									<label style="font-weight:600;" for="post_title" class="form-label"><?php esc_html_e( 'Title', 'dokan-lite' ); ?><span style="font-weight: normal;font-size:12px;"> (Product title length should not be greater than 65 characters.)</span></label>
                                    <div class="dokan-form-group">
                                        <input class="dokan-form-control" maxlength='65' name="post_title" id="post-title" type="text" placeholder="<?php esc_attr_e( 'Product name..', 'dokan-lite' ); ?>" value="<?php echo esc_attr( dokan_posted_input( 'post_title' ) ); ?>">
                                    </div>
                                   ...
                                   <div class="dokan-form-group">
                                        <textarea name="post_excerpt" maxlength="300" id="post-excerpt" rows="3" class="dokan-form-control" placeholder="<?php esc_attr_e( 'Short description of the product... (Character limit is 300)', 'dokan-lite' ); ?>"><?php echo esc_attr( dokan_posted_textarea( 'post_excerpt' ) ); ?></textarea>
                                    </div>
                            ...
                            <div class="dokan-form-group">
                                <label for="post_content" class="control-label"><?php esc_html_e( 'Full Item Description', 'dokan-lite' ) ?> <i class="fa fa-question-circle tips" data-title="<?php esc_attr_e( 'This is the larger section below the Item that should include all the specifics.', 'dokan-lite' ) ?>" aria-hidden="true"></i></label>
