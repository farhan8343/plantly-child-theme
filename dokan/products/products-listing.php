                ...
                <article class="dokan-product-listing-area">
                    ...
                    ?>
                        ...
                        <div class="dokan-w12">
                            ...
                            <form action="" method="POST" class="outofstockform" style="margin-bottom: 25px; width: 100%; float: left;">
                            <label for="showofoutstock">Hide Out of Stock
                                <input type="checkbox" <?php if(get_usermeta(get_current_user_id(),'show_out_of_stock') == 'on') echo 'checked="checked"';?> name="show_out_of_stock">
                            </label>
                            </form>
                            <script>
                                jQuery(document).ready(function(){
                                    jQuery("[name='show_out_of_stock']").change(function(){
                                        jQuery.blockUI.defaults.message = "";
                                        jQuery.blockUI();
                                        ...
                                        jQuery.ajax({
                                            ...
                                            data:{
                                                action:'update_show_out_of_stock_usermeta',
                                                show_out_of_stock: jQuery(this).val()
                                            },
                                            success: function res(res){ console.log(res);
                                                window.location.href = window.location.href;
                                            }
                                        })
                                        //alert(jQuery(this).val());
                                        //jQuery(".outofstockform").trigger('submit');
                                    })
                                })
                            </script>
                        </div>
                            ...
                            <form id="product-filter" method="POST" class="dokan-form-inline">
                                ...
                                <table class="dokan-table dokan-table-striped product-listing-table dokan-inline-editable-table" id="dokan-product-list-table">
                                    ...
                                    <tbody>
										...
										if(get_usermeta(get_current_user_id(),'show_out_of_stock') == 'on'):
