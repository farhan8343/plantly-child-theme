                    ...
                    <div class="profile-info">
                        ...
                        <ul class="dokan-store-info">
                            ...
                            <li class="dokan-store-rating">
								...
								<?php 
								global $wpdb;
								$get = get_posts(array('author' => $store_user->get_id(), 'post_type' => 'product','fields' => 'ids','posts_per_page'=> -1,'post_status'=>'publish'));
								$product_comments = get_comments(array('post_author'=>$store_user->get_id(),'post__in'=> $get,'type' => 'review') );
								...
								if ( $count ) {
									...
									if($count > 0){
										...
										echo "No rating to show";
									}

									//  <span>('. $count . ')</span>'. '
									get_total_vendor_products_sale($store_user->get_id());
								} else {
									$average = 0;
									get_total_vendor_products_sale($store_user->get_id());
								} 
