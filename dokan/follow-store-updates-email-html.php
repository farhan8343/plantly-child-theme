...
<div id="dokan-follow-store">
    <h1 id="dokan-follow-store-title">
        <?php esc_html_e( 'Send them some love!', 'dokan' ); ?>
    </h1>
...
<style type="text/css">
    ...
    /*styling updates email tempalte */

#dokan-follow-store #dokan-follow-store-title{
	font-size: 20px !important;
	text-align:center !important;
}
#dokan-follow-store .vendor-products img {
	width: 120px;
	height: 120px;
    border-radius: 5px !important;
}
#dokan-follow-store .vendor-products .product-name span{
	font-size: 11px;
}
table#template_container{
    margin-bottom: 75px !important;
}
#dokan-follow-store > table > tbody > tr > td > div > table > tbody > tr > td:nth-child(4) > a {
    letter-spacing: 2px;
}
</style>
