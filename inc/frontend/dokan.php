	...
	function add_product_brand_field() {
        ...
        <div class="dokan-form-group">
			...
			$drop_down_brands = wp_dropdown_categories( array(
				'show_option_none' => __( '- Select a Genus -', 'martfury' ),
				'hierarchical'     => 1,
				'hide_empty'       => 0,
				'name'             => 'product_brand[]',
				'id'               => 'product_brand',
			...
			echo str_replace( '<select', '<select data-placeholder="' . esc_html__( 'Select product Genus', 'martfury' ) . '"', $drop_down_brands ); // phpcs:ignore WordPress.XSS.EscapeOutput.OutputNotEscaped
			?>
        </div>
